...
then
	...
	echo -e "========================================================"
        echo -e "\tara - an ARAnyM specific binary"
        echo -e "\tdeb - a debug kernel"
        echo -e "\tmil - a Milan specific binary"
        echo -e "\t000 - a generic 68000 binary (including Debian 68k)"
        echo -e "\t020 - a generic 68020 binary"
        echo -e "\t030 - a generic 68030 binary"
        echo -e "\t040 - a generic 68040 binary"
        echo -e "\t060 - a generic 68060 binary"
        exit
fi
...
echo -e "GEM=u:/c/mint/$VER/xaaes/xaloader.prg" >> mint.cnf
...
echo -e "setenv TOSRUN u:\\\c\\mint\\$VER\\\tools\\\toswin2\\\tw-call.app"  >> xaaes/xaaes.cnf
...
echo -e "run u:\\\c\\mint\\$VER\\\tools\\\toswin2\\\toswin2.app" >> xaaes/xaaes.cnf
echo -e "setenv AVSERVER   \"DESKTOP\"" >> xaaes/xaaes.cnf
echo -e "setenv FONTSELECT \"DESKTOP\"" >> xaaes/xaaes.cnf
echo -e "shell = c:\\mint\\$VER\\\teradesk\\desktop.prg" >> xaaes/xaaes.cnf
